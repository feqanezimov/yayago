...
export default function UsersPage() {
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      ...
      case 'verified':
        return <Badge className="bg-red-100 text-red-800">Verified</Badge>;
      case 'pending':
  ...
  const getRoleBadge = (role: string) => {
    switch (role) {
      case 'owner':
        return <Badge variant="outline" className="border-destructive text-destructive">Car Owner</Badge>;
      case 'renter':
        return <Badge variant="outline" className="border-red-500 text-red-600">Renter</Badge>;
      case 'both':
        return <Badge variant="outline" className="border-red-500 text-red-600">Both</Badge>;
      default:
