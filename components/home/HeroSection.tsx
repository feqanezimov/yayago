      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-20 w-full">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-white space-y-8 animate-fade-in">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Button
                size="lg"
                variant="ghost"
                className="glass-dark text-white hover:bg-white/30 px-8 py-6 text-lg hover-scale"
              >
                Find Auto Services
              </Button>
            </div>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 pt-8">
              {stats.map((stat, index) => (
                <div key={index} className="glass-dark rounded-2xl p-4 text-center hover-scale">
          ...
          <div className="relative animate-slide-up">
            <div className="glass-dark rounded-3xl p-8 hover-scale">
              <img
              ...
              />
              <div className="absolute top-12 right-12 glass rounded-xl p-3">
                <div className="text-white text-center">
                  <div className="text-sm text-gray-300">Starting from</div>
                  <div className="text-2xl font-bold text-primary">AED 89</div>
